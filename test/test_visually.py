...
def write_test_waves(frequency, phase, prefix, suffix):
    ...
    write_and_report_runtime(sine_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase), "{}_sine_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Sine wave at {} Hz".format(frequency) + phase_string)
    write_and_report_runtime(triangle_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase), "{}_tri_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Triangle wave at {} Hz".format(frequency) + phase_string)
    write_and_report_runtime(sawtooth_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase), "{}_saw_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Sawtooth wave at {} Hz".format(frequency) + phase_string)
    write_and_report_runtime(pulse_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase, 0.125), "{}_pulse125_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Pulse wave at {} Hz (12.5% duty cycle)".format(frequency) + phase_string)
    write_and_report_runtime(pulse_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase, 0.25), "{}_pulse25_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Pulse wave at {} Hz (25% duty cycle)".format(frequency) + phase_string)
    write_and_report_runtime(pulse_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase, 0.5), "{}_pulse50_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Pulse wave at {} Hz (50% duty cycle)".format(frequency) + phase_string)
    write_and_report_runtime(pulse_wave(frequency, TEST_AMPLITUDE, TEST_LENGTH, TEST_SAMPLE_RATE, phase, 0.75), "{}_pulse75_{}_{}s".format(prefix, frequency_string, suffix), shape_description="Pulse wave at {} Hz (75% duty cycle)".format(frequency) + phase_string)
